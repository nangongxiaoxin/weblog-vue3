      ...
      <div class="col-span-4 md:col-span-3 mb-3">
        ...
        <div class="w-full p-5 pb-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="text-sm flex flex-wrap gap-3 font-medium text-gray-600 rounded-lg dark:border-gray-600 dark:text-white">
            <a @click="goCategoryArticleListPage(category.id, category.name)" v-for="(category, index) in categories" :key="index" :class="[route.query.name == category.name ? 'bg-sky-100 hover:bg-sky-200' : 'hover:bg-gray-100']" class="inline-flex cursor-pointer items-center px-4 py-2 text-sm font-medium text-center border rounded-lg focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:ring-gray-800 dark:border-gray-700 dark:hover:text-white">
              {{ category.name }}
        ...
        <div class="p-5 mb-4 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
          <h1 class="flex items-center text-lg font-semibold text-gray-900 dark:text-white">
            <!-- 文件夹图标 -->
            <svg t="1698998570037" class="icon w-5 h-5 mr-2" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="21572" width="200" height="200">
              <path d="M938.666667 464.592593h-853.333334v-265.481482c0-62.577778 51.2-113.777778 113.777778-113.777778h128.948148c15.17037 0 28.444444 3.792593 41.718519 11.377778l98.607407 64.474074h356.503704c62.577778 0 113.777778 51.2 113.777778 113.777778v189.62963z" fill="#3A69DD" p-id="21573"></path>
              <path d="M805.925926 398.222222h-587.851852v-125.155555c0-24.651852 20.859259-45.511111 45.511111-45.511111h496.82963c24.651852 0 45.511111 20.859259 45.511111 45.511111V398.222222z" fill="#D9E3FF" p-id="21574"></path>
              <path d="M843.851852 417.185185h-663.703704v-98.607407c0-28.444444 22.755556-53.096296 53.096296-53.096297h559.407408c28.444444 0 53.096296 22.755556 53.096296 53.096297V417.185185z" fill="#FFFFFF" p-id="21575"></path>
              <path d="M786.962963 938.666667h-549.925926c-83.437037 0-151.703704-68.266667-151.703704-151.703704V341.333333s316.681481 37.925926 430.45926 37.925926c189.62963 0 422.874074-37.925926 422.874074-37.925926v445.62963c0 83.437037-68.266667 151.703704-151.703704 151.703704z" fill="#5F7CF9" p-id="21576"></path>
          ...
          <div v-else class="flex items-center justify-center flex-col">
            <svg height="300" node-id="1" sillyvg="true" template-height="600" template-width="600" version="1.1" viewBox="0 0 600 600" width="600" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs node-id="58">
              ...
              <path d="M 199.78 180.97 L 192.47 180.97 C 192.47 166.33 180.60 154.47 165.97 154.47 C 151.33 154.47 139.47 166.33 139.47 180.97 L 134.13 180.97 C 127.39 180.97 121.94 186.90 121.94 194.22 C 121.94 201.54 127.40 207.47 134.13 207.47 L 199.78 207.47 C 206.51 207.47 211.97 201.54 211.97 194.22 C 211.97 186.90 206.51 180.97 199.78 180.97 Z" fill="url(#linearGradient-1)" fill-rule="nonzero" id="路径" node-id="22" stroke="none" target-height="53" target-width="90.034676" target-x="121.93691" target-y="154.4683" />
              <path d="M 445.38 162.31 C 445.38 168.25 439.82 173.00 432.80 173.00 L 393.88 173.00 C 386.85 172.53 381.00 168.01 381.00 161.84 C 381.00 157.80 383.63 154.24 387.44 152.34 C 387.15 151.62 386.85 150.91 386.85 150.20 C 386.85 146.16 390.66 142.60 395.63 142.60 C 397.68 142.60 399.44 143.31 400.90 144.26 C 404.41 138.80 410.85 135.00 418.46 135.00 C 428.99 135.00 437.48 142.36 437.48 151.39 L 437.48 152.34 C 442.16 154.00 445.38 157.80 445.38 162.31 Z" fill="url(#linearGradient-2)" fill-rule="nonzero" id="路径" node-id="23" stroke="none" target-height="38" target-width="64.379456" target-x="381" target-y="135" />
              <path d="M 284.50 415.00 C 345.88 415.00 401.15 420.01 439.79 428.00 C 477.58 428.26 508.00 439.57 508.00 453.50 C 508.00 464.54 488.89 473.94 462.15 477.49 C 455.77 479.37 448.58 481.15 440.69 482.81 C 440.90 483.86 441.00 484.93 441.00 486.00 C 441.00 510.30 388.17 530.00 323.00 530.00 C 264.37 530.00 215.72 514.05 206.55 493.16 C 128.32 487.22 73.00 472.60 73.00 455.50 C 73.00 433.13 167.69 415.00 284.50 415.00 Z" fill="#e7eaf0" fill-rule="evenodd" id="形状结合" node-id="24" stroke="none" target-height="115" target-width="435" target-x="73" target-y="415" />
              <path d="M 284.00 466.10 C 284.00 471.07 268.55 475.10 249.50 475.10 C 230.45 475.10 215.00 471.07 215.00 466.10 C 215.00 461.13 230.45 457.10 249.50 457.10 C 268.55 457.10 284.00 461.13 284.00 466.10 Z" fill="#d1d6e2" fill-rule="nonzero" id="椭圆形" node-id="25" stroke="none" target-height="18" target-width="69" target-x="215" target-y="457.09875" />
              <path
              ...
              <path
                ...
                target-y="370"
              />
              <path d="M 164.00 263.00 L 213.96 263.00 L 222.26 276.15 L 291.94 276.03 L 296.34 276.32 L 300.48 277.16 L 304.40 278.52 L 308.12 280.38 L 311.51 282.66 L 314.59 285.36 L 317.30 288.43 L 319.59 291.81 L 321.46 295.52 L 322.84 299.44 L 323.69 303.58 L 324.00 307.97 L 324.00 308.03 L 324.00 409.00 L 324.00 409.00 L 164.00 409.00 L 164.00 263.00 Z" fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="31" stroke="none" target-height="146" target-width="160" target-x="164" target-y="263" />
              <path d="M 181.00 295.00 L 311.00 295.00 L 311.00 439.00 L 181.00 439.00 Z" fill="#a2abb9" fill-rule="evenodd" group-id="3" id="矩形" node-id="32" stroke="none" target-height="144" target-width="130" target-x="181" target-y="295" />
              <path d="M 178.00 309.00 L 314.00 309.00 L 314.00 436.00 L 178.00 436.00 Z" fill="#ffffff" fill-rule="evenodd" group-id="3" id="矩形" node-id="33" stroke="none" target-height="127" target-width="136" target-x="178" target-y="309" />
              <path d="M 177.00 318.00 L 318.00 318.00 L 318.00 435.00 L 177.00 435.00 Z" fill="#c8cede" fill-rule="evenodd" group-id="3" id="矩形" node-id="34" stroke="none" target-height="117" target-width="141" target-x="177" target-y="318" />
              <path d="M 151.00 331.00 L 341.00 331.00 L 323.73 439.00 L 168.27 439.00 Z" fill="url(#linearGradient-5)" fill-rule="nonzero" group-id="3" id="矩形" node-id="35" stroke="none" target-height="108" target-width="190" target-x="151" target-y="331" />
              <path d="M 264.50 378.00 L 264.50 378.00 L 265.87 378.28 L 266.97 379.03 L 267.72 380.13 L 268.00 381.50 L 268.00 381.50 L 267.72 382.87 L 266.97 383.97 L 265.87 384.72 L 264.50 385.00 L 264.50 385.00 L 263.13 384.72 L 262.03 383.97 L 261.28 382.87 L 261.00 381.50 L 261.00 381.50 L 261.28 380.13 L 262.03 379.03 L 263.13 378.28 L 264.50 378.00 Z" fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="36" stroke="none" target-height="7" target-width="7" target-x="261" target-y="378" />
              <path d="M 278.50 378.00 L 302.50 378.00 L 303.87 378.28 L 304.97 379.03 L 305.72 380.13 L 306.00 381.50 L 306.00 381.50 L 305.72 382.87 L 304.97 383.97 L 303.87 384.72 L 302.50 385.00 L 278.50 385.00 L 277.13 384.72 L 276.03 383.97 L 275.28 382.87 L 275.00 381.50 L 275.00 381.50 L 275.28 380.13 L 276.03 379.03 L 277.13 378.28 L 278.50 378.00 Z" fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="37" stroke="none" target-height="7" target-width="31" target-x="275" target-y="378" />
              <path d="M 263.50 393.00 L 301.50 393.00 L 302.87 393.28 L 303.97 394.03 L 304.72 395.13 L 305.00 396.50 L 305.00 396.50 L 304.72 397.87 L 303.97 398.97 L 302.87 399.72 L 301.50 400.00 L 263.50 400.00 L 262.13 399.72 L 261.03 398.97 L 260.28 397.87 L 260.00 396.50 L 260.00 396.50 L 260.28 395.13 L 261.03 394.03 L 262.13 393.28 L 263.50 393.00 Z" fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形备份-2" node-id="38" stroke="none" target-height="7" target-width="45" target-x="260" target-y="393" />
              <path d="M 251.00 256.00 L 250.75 258.74 L 250.06 261.25 L 248.95 263.57 L 247.46 265.68 L 245.68 267.46 L 243.57 268.95 L 241.25 270.06 L 238.74 270.75 L 236.00 271.00 L 233.26 270.75 L 230.75 270.06 L 228.43 268.95 L 226.32 267.46 L 224.54 265.68 L 223.05 263.57 L 221.94 261.25 L 221.25 258.74 L 221.00 256.00 L 221.25 253.26 L 221.94 250.75 L 223.05 248.43 L 224.54 246.32 L 226.32 244.54 L 228.43 243.05 L 230.75 241.94 L 233.26 241.25 L 236.00 241.00 L 238.74 241.25 L 241.25 241.94 L 243.57 243.05 L 245.68 244.54 L 247.46 246.32 L 248.95 248.43 L 250.06 250.75 L 250.75 253.26 L 251.00 256.00 Z" fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="椭圆形" node-id="39" stroke="none" target-height="30" target-width="30" target-x="221" target-y="241" />
              <path d="M 236.00 261.00 L 230.12 264.09 L 231.24 257.55 L 226.49 252.91 L 233.06 251.95 L 236.00 246.00 L 238.94 251.95 L 245.51 252.91 L 240.76 257.55 L 241.88 264.09 Z" fill="#ffffff" fill-rule="evenodd" group-id="3" id="星形" node-id="40" stroke="none" target-height="18.09018" target-width="19.021118" target-x="226.48944" target-y="246" />
              <path d="M 376.00 255.00 L 375.70 259.40 L 374.85 263.53 L 373.49 267.46 L 371.62 271.17 L 369.34 274.55 L 366.63 277.63 L 363.55 280.34 L 360.17 282.62 L 356.46 284.49 L 352.53 285.85 L 348.40 286.70 L 344.00 287.00 L 339.60 286.70 L 335.47 285.85 L 331.54 284.49 L 327.83 282.62 L 324.45 280.34 L 321.37 277.63 L 318.66 274.55 L 316.38 271.17 L 314.51 267.46 L 313.15 263.53 L 312.30 259.40 L 312.00 255.00 L 312.30 250.60 L 313.15 246.47 L 314.51 242.54 L 316.38 238.83 L 318.66 235.45 L 321.37 232.37 L 324.45 229.66 L 327.83 227.38 L 331.54 225.51 L 335.47 224.15 L 339.60 223.30 L 344.00 223.00 L 348.40 223.30 L 352.53 224.15 L 356.46 225.51 L 360.17 227.38 L 363.55 229.66 L 366.63 232.37 L 369.34 235.45 L 371.62 238.83 L 373.49 242.54 L 374.85 246.47 L 375.70 250.60 L 376.00 255.00 Z" fill="#c0c9db" fill-rule="evenodd" group-id="3" id="椭圆形" node-id="41" stroke="none" target-height="64" target-width="64" target-x="312" target-y="223" />
              <path
        ...
        <nav aria-label="Page navigation example" class="mt-10 flex justify-center" v-if="pages >= 1">
          <ul class="flex items-center -space-x-px h-10 text-base">
            <!-- 上一页 -->
            <li>
              <a @click="getCategoryArticles(current - 1)" class="flex items-center justify-center px-4 h-10 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" :class="[current > 1 ? '' : 'cursor-not-allowed']">
            ...
            <li v-for="(pageNo, index) in pages" :key="index">
              <a @click="getCategoryArticles(pageNo)" class="flex items-center justify-center px-4 h-10 leading-tight border dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" :class="[pageNo == current ? 'text-blue-600  bg-blue-50 border-blue-300 hover:bg-blue-100 hover:text-blue-700' : 'text-gray-500 border-gray-300 bg-white hover:bg-gray-100 hover:text-gray-700']">
                {{ index + 1 }}
              </a>
            </li>
            <!-- 下一页 -->
            <li>
              <a @click="getCategoryArticles(current + 1)" class="flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" :class="[current < pages ? '' : 'cursor-not-allowed']">
