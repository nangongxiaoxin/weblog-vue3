<template>
  <div class="main min-h-screen flex flex-col">
    ...
    <main class="grow container max-w-screen-3xl mx-auto px-4 sm:px-6 md:px-8 py-4">
        ...
        <div class="max-w-3xl mx-auto xl:max-w-none xl:ml-0 xl:mr-[15.5rem] xl:pr-16">
          ...
          <article>
            ...
            <div class="mt-5">
              ...
              <div class="flex gap-3 md:gap-6 text-gray-400 items-center text-sm pb-3 border-b border-gray-100 dark:border-gray-800">
                <!-- 字数 -->
            ...
            <div :class="{ dark: isDark }">
              <div class="article-content" v-viewer v-html="article.content"></div>
            </div>
            <!-- 最后编辑时间 -->
      ...
      <div class="fixed top-[3.8125rem] bottom-0 right-[max(0px,calc(50%-50rem))] w-[19.5rem] py-10 overflow-y-auto hidden xl:block">
        <WikiToc></WikiToc>
      </div>
    </main>
    <!-- 返回顶部 -->
