        ...
        <el-table-column fixed="right" label="操作" width="160">
          <template #default="scope">
            ...
            <el-tooltip class="box-item" effect="dark" content="编辑目录" placement="bottom">
              <el-button size="small" :icon="Tickets" circle> </el-button>
            </el-tooltip>
...
function getTableData() {
  ...
  //调用后台分页接口，并传入参数
  getWikiPageList({ current: current.value, size: size.value, startDate: startDate.value, endDate: endDate.value, title: searchWikiTitle.value }).then((res) => {
    if (res.success == true) {
