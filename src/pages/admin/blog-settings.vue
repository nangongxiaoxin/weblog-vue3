    ...
    <el-card shadow="never">
      ...
      <el-form ref="formRef" :model="form" label-width="160px" :rules="rules">
        ...
        <el-form-item label="介绍语" prop="introduction">
          <el-input v-model="form.introduction" clearable />
        </el-form-item>
        ...
        <el-form-item label="作者头像" prop="avatar">
          <el-upload class="avatar-uploader" action="#" :on-change="handleAvatarChange" :auto-upload="false" :show-file-list="false">
...
function initBlogSettings() {
  ...
  getBlogSettingsDetail().then((e) => {
    if (e.success == true) {
      ...
      //第三方平台信息设置，先判断后台返回的信息是否为空，若不为空，则将switch按钮设置为开启状态，并设置表单的相应数据
