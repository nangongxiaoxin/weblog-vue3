  ...
  <div>
    ...
    <el-card shadow="never" class="mb-5">
      ...
      <div class="flex items-center">
        ...
        <div class="ml-3 w-52 mr-5"><el-input v-model="searchRouterUrl" placeholder="请输入（模糊查询）" clearable /></div>
      ...
      <el-table :data="tableData" border stripe v-loading="tableLoading" table-layout="auto">
        ...
        <el-table-column prop="routerUrl" label="路由">
          <template #default="scope">
            <el-link type="primary" :href="'#' + scope.row.routerUrl" target="_blank">{{ scope.row.routerUrl }}</el-link>
          </template>
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="150">
          <template #default="scope">
            <el-tooltip class="box-item" effect="dark" content="详情" placement="bottom">
              <el-button size="small" :icon="Tickets" circle @click="showDetailDialog(scope.row)"> </el-button>
            </el-tooltip>

            <el-tooltip v-if="scope.row.status == 1" class="box-item" effect="dark" content="审核" placement="bottom">
              <el-button size="small" :icon="Edit" circle @click="showEditDetailDialog(scope.row)"> </el-button>
            </el-tooltip>

            <el-tooltip class="box-item" effect="dark" content="删除" placement="bottom">
              <el-button type="danger" size="small" :icon="Delete" @click="deleteCommentSubmit(scope.row)" circle> </el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
